...
namespace CicekSepeti.Data.Migrations
{
    ...
    [Migration("20241214003448_NewsConfiguration")]
            ...
            modelBuilder.Entity("CicekSepeti.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDate = new DateTime(2024, 12, 14, 3, 34, 47, 801, DateTimeKind.Local).AddTicks(4340),
                            ...
                            Password = "123456*",
                            Surname = "User",
                            UserGuid = new Guid("c50983d8-465e-4cc5-a517-4a2581bef4e5"),
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("CicekSepeti.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDate = new DateTime(2024, 12, 14, 3, 34, 47, 804, DateTimeKind.Local).AddTicks(2055),
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Elektronik",
                            OrderNo = 1,
                        ...
                        {
                            ID = 2,
                            CreateDate = new DateTime(2024, 12, 14, 3, 34, 47, 804, DateTimeKind.Local).AddTicks(2725),
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Bilgisayar",
                            OrderNo = 2,
